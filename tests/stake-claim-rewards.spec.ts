...
describe("Stake and claim rewards", () => {
  ...
  before(async () => {
    ...
    [originalMintTokenAccountId, originalMint] = await createMint(
      ...
      console.log("originalMint : ", originalMint.publicKey.toString());
      console.log("originalMintTokenAccountId : ",originalMintTokenAccountId.toString());
    // master edition
  ...
  it("Create Pool", async () => {
    ...
    //   {}
    // );
    // console.log("stakePoolId : ", stakePoolId.toString());
    // await expectTXTable(
